    ...
    assert_that(result, has_entries(
        {'name': 'test-chart', 'appVersion': '1.16.0', 'apiVersion': 'v2', 'version': '0.1.0',
         ...
         'values': [
             ...
             {'name': 'serviceAccount', 'description': '', 'default': {'create': True, 'annotations': {}, 'name': ''},
              'example': ''}, {'name': 'podAnnotations', 'description': '', 'default': {}, 'example': ''},
             ...
             {'name': 'ingress', 'description': '', 'default': {'enabled': False, 'className': '', 'annotations': {},
                                                                'hosts': [{'host': 'chart-example.local', 'paths': [
                                                                    {'path': '/',
                                                                     'pathType': 'ImplementationSpecific'}]}],
                                                                'tls': []}, 'example': ''},
             {'name': 'resources', 'description': '', 'default': {}, 'example': ''},
             {'name': 'autoscaling', 'description': '',
              'default': {'enabled': False, 'minReplicas': 1, 'maxReplicas': 100, 'targetCPUUtilizationPercentage': 80},
              'example': ''}, {'name': 'nodeSelector', 'description': '', 'default': {}, 'example': ''},
             {'name': 'tolerations', 'description': '', 'default': [], 'example': ''},
             {'name': 'affinity', 'description': '', 'default': {}, 'example': ''}],
         'templates': [{'path': 'deployment.yaml'}, {'path': 'ingress.yaml'}, {'path': 'service.yaml'},
